  ...
  return (
    <div className="relative mx-auto my-10 flex max-w-7xl flex-col items-center justify-center">
      ...
      <div className="px-4 py-10 md:py-20">
        ...
        >
          See your estimated SAT score instantly — no practice test required.
          Just upload your transcript or enter your courses and grades to get a personalized score prediction, targeted study advice, and a custom day-by-day prep plan.
        </motion.p>
        <motion.div
          initial={{
            opacity: 0,
